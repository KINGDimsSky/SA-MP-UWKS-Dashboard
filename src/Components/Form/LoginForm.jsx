      ...
      <div className="border border-gray-200 shadow-2xl p-4 flex flex-col w-[26rem]">
          <div className="flex items-center gap-2">
           ...
           <div className="LoginAuth items-center mt-6 flex flex-col">
                ...
                <Button Logo={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30">
           ...
           <div className="Formku ">
              ...
              <Button className="mt-4 py-2 bg-purple-500 text-white">
                  Continue
              </Button>
              <h2 className='mt-6 text-xs tracking-tighter'>Dont Have Account?<a className='ml-1 font-semibold text-purple-500' href="">Sign Up</a></h2>
           </div>
      </div>   
    </div>
  )
