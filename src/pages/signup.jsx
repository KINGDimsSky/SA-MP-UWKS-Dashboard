      ...
      <div className="flex gap-2 items-center mb-1">
        ...
        <h2 className='font-semibold text-xl'>Sign Up</h2>
          ...
          <div className="garisMoment mb-6 gap-2 flex items-center justify-center">
           ...
           <div className="LoginAuth items-center mt-1 flex flex-col">
           ...
           <h2 className='mt-6 text-xs tracking-tighter'>Already Have Account?<Link to="/signin" className='ml-1 font-semibold text-purple-500'>Sign In</Link></h2>
    </AuthLayout>
  )
}
